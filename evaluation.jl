...
function eval_the_prog()
    ...
    for indx in 1:length(Samples)
        ...
        U, r, consistent = rankconsistencyTeamID16(A,b); # call your function here
    ...
    timetaken = @belapsed rankconsistencyTeamID16($Samples[25].A,$Samples[25].b) evals=1 samples=5 seconds=10
...
#include("temp.jl")
#include("temp.jl")
include("EE5609TeamID16.jl") # include your file here
